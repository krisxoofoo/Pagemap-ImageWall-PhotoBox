...
/*
	...
	Version "PhotoBox" adapted by kris - https://xoofoo.org
*/
...
<?php if($config['Embedded Script'] == 'off') { ?>
	<footer>
		...
		<p>Powered by <strong>Pagemap ImageWall</strong> adapted by <a class="bulbe" href="https://xoofoo.org/" title="XooFoo Websites"><strong>XooFoo</strong></a></p>
	</footer>
<?php } ?>
</div>
